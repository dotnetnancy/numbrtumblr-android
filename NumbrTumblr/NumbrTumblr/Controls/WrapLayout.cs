    ...
    public class WrapLayout : Layout<View>
    {
        ...
        void ItemsSourceChanged()
        {
            ...
            if (ItemsSource != null)
            {
                ...
                {
                    //NH only changed this line cause i was using a custom cell which derives from viewcell and 
                    //has a property of view rather than is a view like other item templates.
                    //var view = (View)ItemTemplate.CreateContent();
                    var view = ((ViewCell)ItemTemplate.CreateContent()).View;
